...
def main(config, pre_config):
    ...
    for file_idx, batch in enumerate(dataloader) :
        ...
        for idx, sample in enumerate(samples) :
            ...
            audio, text = th.tensor(audio).float().to('cuda:1'), th.tensor(text).float().to('cuda:1')
...
def create_argparser():
    defaults = dict(
        ...
        batch_size=1,
        use_ddim=False,
        model_path="C://Users//PC//PycharmProjects_2023//GENEA2023//ckpts//diffusion_no_prepose//model189000.pt",
    )
