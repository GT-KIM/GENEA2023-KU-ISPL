...
if __name__ == "__main__":
    ...
    os.makedirs("ckpts/pipeline", exist_ok=True)
    jl.dump(mexp_full, "ckpts/pipeline/pipeline_expmap_full.sav")
    jl.dump(mexp_upperbody, "ckpts/pipeline/pipeline_expmap_upper.sav")
