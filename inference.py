...
def main(config, pre_config):
    ...
    with open("outputs/mean_pose.txt", 'r') as f:
        t = ''.join(f.readlines())
    ...
    for file_idx, batch in enumerate(dataloader) :
        ...
        for idx, sample in enumerate(samples) :
            ...
            if idx == 0 :
                pre_pose = th.tensor([mean_pose for _ in range(8)]).to('cuda:1')
...
def create_argparser():
    defaults = dict(
        ...
        batch_size=1,
        use_ddim=False,
        model_path="C://Users//PC//PycharmProjects_2023//GENEA2023//ckpts//diffusion//model061000.pt",
    )
